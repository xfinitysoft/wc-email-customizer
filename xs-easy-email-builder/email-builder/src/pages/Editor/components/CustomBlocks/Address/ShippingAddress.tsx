...
export type IShippingAddress = IBlockData<
  {
    'align':string;
...
>;
export const ShippingAddress = createCustomBlock<IShippingAddress>({
    name: 'Shipping Address',
    type: CustomBlocksType.ShippingAddress,
    validParentType:[AdvancedType.COLUMN, BasicType.COLUMN],
    create: payload => {
        const defaultData: IShippingAddress = {
            type: CustomBlocksType.ShippingAddress,
            data:{
                value:{
